        ...
        if frame is not None:
            ...
            if calib == 1:  
                if METHOD == 0:
                    ...
                    draw_parallel(big_image,'vertical',int((cur_pointer[1]+cur_pointer[0])/2), (0,0,255))
                    draw_parallel(big_image,'horizontal',int((cur_pointer[2]+cur_pointer[3])/2), (0,0,255))
